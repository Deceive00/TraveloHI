...
type Seats struct {
	...
	Airplane Airplanes `gorm:"foreignKey:AirplaneID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
	SeatClassID uint `json:"seatClassId"`
	SeatClass SeatClass `gorm:"foreignKey:SeatClassID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
}
